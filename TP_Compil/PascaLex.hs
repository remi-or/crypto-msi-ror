...
alex_table = listArray (0 :: Int, 1325)
  [ 0
  , 34
  , 34
  , 34
...
alex_check = listArray (0 :: Int, 1325)
  [ -1
  , 9
  , 10
  , 11
...
alex_accept = listArray (0 :: Int, 71)
  [ AlexAccNone
  , AlexAcc 59
  , AlexAcc 58
  , AlexAccNone
...
alex_action_1 = \p _ -> TK_SEP p
alex_action_2 = \p _ -> TK_OPP p
alex_action_3 = \p _ -> TK_CLP p
alex_action_5 = \p _ -> TK_OPCB p
alex_action_6 = \p _ -> TK_CLCB p
alex_action_7 = \p _ -> TK_OPBR p
alex_action_8 = \p _ -> TK_CLBR p
alex_action_9 = \p _ -> TK_IF p
alex_action_10 = \p _ -> TK_THEN p
alex_action_11 = \p _ -> TK_ELSE p
alex_action_12 = \p _ -> TK_WHILE p
alex_action_13 = \p _ -> TK_PRINT p
alex_action_14 = \p _ -> TK_INPUT p
alex_action_15 = \p _ -> TK_RETURN p
alex_action_16 = \p _ -> TK_DEF p
alex_action_17 = \p _ -> TK_TRUE p
alex_action_18 = \p _ -> TK_FALSE p
alex_action_19 = \p _ -> TK_DECLARATION p
alex_action_20 = \p n -> TK_VAR p n
alex_action_21 = \p s -> TK_INT p (read s)
alex_action_22 = \p _ -> TK_INT p 0
alex_action_23 = \p _ -> TK_ADD  p
alex_action_24 = \p _ -> TK_SUB  p
alex_action_25 = \p _ -> TK_MUL  p
alex_action_26 = \p _ -> TK_DIV  p
alex_action_27 = \p _ -> TK_EQ   p
alex_action_28 = \p _ -> TK_MOD  p
alex_action_29 = \p _ -> TK_INFS p
alex_action_30 = \p _ -> TK_INFE p
alex_action_31 = \p _ -> TK_SUPS p
alex_action_32 = \p _ -> TK_SUPE p
alex_action_33 = \p _ -> TK_ISEQ p
alex_action_34 = \p _ -> TK_ISDF p
